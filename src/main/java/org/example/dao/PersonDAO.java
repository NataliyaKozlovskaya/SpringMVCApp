...
public class PersonDAO {
    ...
    public void update(int id, Person updatedPerson) {
       jdbcTemplate.update("UPDATE Person SET name=?, email=?, age=?, address=? WHERE id=?", updatedPerson.getName(), updatedPerson.getEmail(), updatedPerson.getAge(), updatedPerson.getAddress(), id);
    }
...
////////////////
    ...
    private List<Person> create1000People() {
        ...
        for (int i=0; i<1000; i++){
            people.add(new Person(i, "Name: "+ i, "test@ "+i, 30, "some_address"));
        }
        return people;
    }
}
